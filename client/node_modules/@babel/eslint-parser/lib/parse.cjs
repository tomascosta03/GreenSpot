...
<<<<<<< HEAD
    throw new Error(`@babel/eslint-parser@${"7.24.5"} does not support @babel/core@${client.getVersion()}. Please upgrade to @babel/core@${minSupportedCoreVersion}.`);
=======
    throw new Error(`@babel/eslint-parser@${"7.23.10"} does not support @babel/core@${client.getVersion()}. Please upgrade to @babel/core@${minSupportedCoreVersion}.`);
